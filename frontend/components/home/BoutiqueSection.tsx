...
import CommandeModal from "../Boutique/CommandeModal";
...
function ProductCard({ product, index }: { product: Product; index: number }) {
  ...
  const handleOpenOrderModal = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    <>
      ...
      >
        ...
        <div className={styles.cardBody}>
          ...
          <div className={styles.cardFooter}>
            ...
            {product.on_order ? (
              <button
                ...
                aria-label={`Commander ${product.name} sur commande`}
                onClick={handleOpenOrderModal}
              >
                {/* Icône crayon/commande sur mesure */}
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
          ...
          {orderSuccess && (
            <p style={{ fontSize: "11px", color: "#2d9b6f", marginTop: "4px" }}>
              Commande envoyée ✓
            </p>
          )}
        </div>
